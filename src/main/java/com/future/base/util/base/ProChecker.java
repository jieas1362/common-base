...
import com.future.base.constant.common.Status;
import com.future.base.model.common.IdentityParam;
...
import static com.future.base.constant.common.Status.VALID;
...
public final class ProChecker {
     ...
     * @return
     */
    public static boolean isGreaterThanZero(Double arg) {
        return arg != null && arg > 0L;
    }
     ...
     * @param identity
     */
    public static boolean isInvalidIdentity(Integer identity) {
     ...
     * @param identity
     */
    public static boolean isValidIdentity(Integer identity) {
        return identity != null && identity >= 0;
    }
    ...
    public static boolean isInvalidIdentities(Collection<Long> identities) {
        return identities == null || identities.size() <= 0 || identities.parallelStream().anyMatch(ProChecker::isInvalidIdentity);
    }
    ...
    public static boolean isValidIdentities(Collection<Long> identities) {
        return identities != null && identities.size() > 0 && identities.parallelStream().anyMatch(ProChecker::isValidIdentity);
    }
    ...
    public static long assertIdentityParamsAndReturnIdForOperate(IdentityParam identityParam, Long operatorId) {
        ...
        if (isInvalidIdentity(operatorId))
            throw new ProException(UNAUTHORIZED);
