...
import static com.future.base.constant.common.ProAttr.DATE_TIME_FORMATTER;
import static com.future.base.constant.common.ProAttr.TIME_ZONE;
import static com.future.base.constant.common.ResponseElement.TIME_FORMAT_IS_INVALID;
import static com.future.base.util.base.ProChecker.isNotBlank;
...
public final class TimeUnity {
    ...
    public static LocalDateTime convertStrToLocalDateTime(String dateTime) {
        ...
        try {
            ...
            throw new ProException(TIME_FORMAT_IS_INVALID);
        }
    }
     ...
     * @return
     */
    public static String currentToStr(DateTimeFormatter dateTimeFormatter) {
        Assert.isTrue(isNotNull(dateTimeFormatter), "dateTimeFormatter can't be null");
     ...
     * @return
     */
    public static String dateToStr(Long milli, DateTimeFormatter dateTimeFormatter, Locale locale) {
        return convertMilliToLocalDateTime(milli).format(dateTimeFormatter.withLocale(locale));
    }
}
